...
public class RPCProxyTest {
    ...
    **/
    ...
    public void proxyDoesConnect()
    {
        ...
        assertTrue("Status Info is not OK", this.proxy.getConHandler().getBuilder().isStatusInfoOk());
    }
    ...
    public void testMainProtocol(){
        ...
        assertTrue("Status Info is not OK", this.proxy.getConHandler().getHeader() >= 0);
    }
}
