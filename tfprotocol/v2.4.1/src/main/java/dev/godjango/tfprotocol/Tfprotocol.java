...
import static dev.godjango.tfprotocol.constants.TfprotocolConsts.PutGetCommand.*;
...
import dev.godjango.tfprotocol.callbacks.ITfprotocolCallback;
import dev.godjango.tfprotocol.connection.Easyreum;
import dev.godjango.tfprotocol.connection.EasyreumUDP;
import dev.godjango.tfprotocol.constants.TfprotocolConsts;
import dev.godjango.tfprotocol.misc.FileManager;
...
public final class Tfprotocol extends TfprotocolSuper<ITfprotocolCallback> {
    ...
    public static final class Codes{
         ...
         * @see dev.godjango.tfprotocol.constants.XSACEConsts
         * */
